...
def test_cli_usage_and_flag_errors(run_wtk, repo_factory) -> None:
    ...
    cases = [
        ...
        (("auxiliary-group",), "missing required subcommand: add, list, or remove", "wtk auxiliary-group <subcommand>"),
        (("ag", "add"), "missing required argument: group-name", "wtk auxiliary-group <subcommand>"),
        (("ag", "add", "full-stack"), "missing required argument: repository-path", "wtk auxiliary-group <subcommand>"),

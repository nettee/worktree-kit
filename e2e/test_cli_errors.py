...
def test_cli_usage_and_flag_errors(run_wtk, repo_factory) -> None:
    ...
    cases = [
        ...
        (("auxiliary-group",), "missing required subcommand: add", "wtk auxiliary-group add <group-name> <repository-path>..."),
        (("ag", "add"), "missing required argument: group-name", "wtk auxiliary-group add <group-name> <repository-path>..."),
        (("ag", "add", "full-stack"), "missing required argument: repository-path", "wtk auxiliary-group add <group-name> <repository-path>..."),
